...
public class MTELargeTurbineHPSteamModern extends MTEExtendedPowerMultiBlockBase<MTELargeTurbineHPSteamModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTELargeTurbineHPSteamModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTELargeTurbineHPSteamModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTELargeTurbineHPSteamModern.class)
                ...
                .buildAndChain(
                    onElementPass(
                        MTELargeTurbineHPSteamModern::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTELargeTurbineHPSteamModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTELargeTurbineHPSteamModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTELargeTurbineHPSteamModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTELargeTurbineHPSteamModern(this.mName);
    }
