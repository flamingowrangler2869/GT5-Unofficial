...
public enum ItemList implements IItemContainer {
    ...
    Controller_XL_Turbine_Steam,
    Controller_XL_Turbine_HPSteam,
    Controller_XL_Turbine_SCSteam,
    Controller_XL_Turbine_Plasma,
    Controller_XL_Turbine_Gas,
    Controller_Large_Turbine_Steam,
    Controller_Large_Turbine_HPSteam,
    Controller_Large_Turbine_SCSteam,
    Controller_Large_Turbine_Plasma,
    Controller_Large_Turbine_Gas,
    Controller_Large_Boiler_Bronze_Legacy,
    Controller_Large_Boiler_Steel_Legacy,
    Controller_Large_Boiler_Titanium_Legacy,
    Controller_Large_Boiler_TungstenSteel_Legacy,
    Machine_Multi_DieselEngine_Legacy,
    Machine_Multi_ExtremeDieselEngine_Legacy,
    GT4_Thermal_Boiler,
