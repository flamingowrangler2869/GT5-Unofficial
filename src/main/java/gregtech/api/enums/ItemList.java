...
public enum ItemList implements IItemContainer {
    ...
    Controller_Industrial_ThermalCentrifuge_Modern,
    Controller_Industrial_MacerationStack_Modern,
    Controller_Industrial_WireFactory_Modern,
    Controller_Industrial_CuttingFactory_Modern,
    Controller_Industrial_WashPlant_Modern,
    Controller_Industrial_Sifter_Modern,
    Controller_Industrial_Centrifuge_Modern,
    Controller_Industrial_Electrolyzer_Modern,
    Controller_Industrial_Mixer_Modern,
    Controller_Industrial_CokeOven_Modern,
    Controller_Industrial_TreeFarm_Modern,
    ...
    Controller_Pyrolyse_Oven_Modern,
    Controller_Drone_Centre_Modern,
    Controller_Industrial_AutoChisel_Modern,
    Controller_Industrial_ForgeHammer_Modern,
    Controller_Amazon_Warehouse_Modern,
    Controller_Industrial_RockBreaker_Modern,
    Controller_Multiblock_Pump_Infinite_Modern,
    Controller_Mega_Blast_Furnace_Modern,
    Controller_Mega_Vacuum_Freezer_Modern,
    Controller_Mega_Distillation_Tower_Modern,
    Controller_Mega_Chemical_Reactor_Modern,
    Controller_XL_Turbine_Steam_Modern,
    Controller_XL_Turbine_SHSteam_Modern,
    Controller_XL_Turbine_SCSteam_Modern,
    Controller_XL_Turbine_Plasma_Modern,
    Controller_XL_Turbine_Gas_Modern,
    Controller_Large_Turbine_Steam_Modern,
    Controller_Large_Turbine_SHSteam_Modern,
    Controller_Large_Turbine_SCSteam_Modern,
    Controller_Large_Turbine_Plasma_Modern,
    Controller_Large_Turbine_Gas_Modern,
    Controller_Large_Boiler_Bronze_Modern,
    Controller_Large_Boiler_Steel_Modern,
    Controller_Large_Boiler_Titanium_Modern,
    Controller_Large_Boiler_TungstenSteel_Modern,
    Controller_Extreme_Combustion_Engine_Modern,
    Controller_Combustion_Engine_Modern,
    Controller_GT4_Thermal_Boiler_Modern,
    Controller_Multi_Naquadah_Generator_Modern,
    Controller_Multi_Naquadah_Refinery_Modern,
    Controller_UniversalChemicalFuelEngine_Modern,
    Controller_Solid_Oxide_Fuel_Cell_MKI,
    Controller_Solid_Oxide_Fuel_Cell_MKII,
