    ...
    private static void run1() {
        GregtechItemList.Large_Steam_Turbine.set(
            new MTELargeTurbineSteam(
                ...
                "§c§lDEPRECATED§7 - " + "multimachine.largerturbine",
                "§c§lDEPRECATED§7 - " + "XL Turbo Steam Turbine").getStackForm(1L));
        GregtechItemList.Large_HPSteam_Turbine.set(
            new MTELargeTurbineSHSteam(
                Large_HPSteam_Turbine.ID,
                "§c§lDEPRECATED§7 - " + "multimachine.largerhpturbine",
                "§c§lDEPRECATED§7 - " + "XL Turbo HP Steam Turbine").getStackForm(1L));
        GregtechItemList.Large_Gas_Turbine.set(
            new MTELargeTurbineGas(
                Large_Gas_Turbine.ID,
                "§c§lDEPRECATED§7 - " + "multimachine.largergasturbine",
                "§c§lDEPRECATED§7 - " + "XL Turbo Gas Turbine").getStackForm(1L));
        GregtechItemList.Large_Plasma_Turbine.set(
            new MTELargerTurbinePlasma(
                Large_Plasma_Turbine.ID,
                "§c§lDEPRECATED§7 - " + "multimachine.largerplasmaturbine",
                "§c§lDEPRECATED§7 - " + "XL Turbo Plasma Turbine").getStackForm(1L));
        GregtechItemList.Large_SCSteam_Turbine.set(
            new MTELargeTurbineSCSteam(
                Large_SCSteam_Turbine.ID,
                "§c§lDEPRECATED§7 - " + "multimachine.largerscturbine",
                "§c§lDEPRECATED§7 - " + "XL Turbo SC Steam Turbine").getStackForm(1L));
