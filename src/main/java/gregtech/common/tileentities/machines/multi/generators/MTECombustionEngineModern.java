...
public class MTECombustionEngineModern extends MTEExtendedPowerMultiBlockBase<MTECombustionEngineModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTECombustionEngineModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTECombustionEngineModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTECombustionEngineModern.class)
                ...
                .dot(1)
                .buildAndChain(
                    onElementPass(MTECombustionEngineModern::onCasingAdded, ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTECombustionEngineModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTECombustionEngineModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTECombustionEngineModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTECombustionEngineModern(this.mName);
    }
