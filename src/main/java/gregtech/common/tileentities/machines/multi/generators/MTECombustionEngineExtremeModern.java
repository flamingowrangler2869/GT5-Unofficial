...
public class MTECombustionEngineExtremeModern extends MTEExtendedPowerMultiBlockBase<MTECombustionEngineExtremeModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTECombustionEngineExtremeModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTECombustionEngineExtremeModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTECombustionEngineExtremeModern.class)
                ...
                .buildAndChain(
                    onElementPass(
                        MTECombustionEngineExtremeModern::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTECombustionEngineExtremeModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTECombustionEngineExtremeModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTECombustionEngineExtremeModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTECombustionEngineExtremeModern(this.mName);
    }
