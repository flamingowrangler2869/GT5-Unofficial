...
public class MTESOFuelCellMK1Modern extends MTEExtendedPowerMultiBlockBase<MTESOFuelCellMK1Modern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTESOFuelCellMK1Modern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTESOFuelCellMK1Modern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTESOFuelCellMK1Modern.class)
                ...
                .dot(1)
                .buildAndChain(
                    onElementPass(MTESOFuelCellMK1Modern::onCasingAdded, ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTESOFuelCellMK1Modern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTESOFuelCellMK1Modern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTESOFuelCellMK1Modern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTESOFuelCellMK1Modern(this.mName);
    }
