...
public class MTEAlgaeFarmModern extends MTEExtendedPowerMultiBlockBase<MTEAlgaeFarmModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTEAlgaeFarmModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTEAlgaeFarmModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTEAlgaeFarmModern.class)
                ...
                .dot(1)
                .buildAndChain(
                    onElementPass(MTEAlgaeFarmModern::onCasingAdded, ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTEAlgaeFarmModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTEAlgaeFarmModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTEAlgaeFarmModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTEAlgaeFarmModern(this.mName);
    }
