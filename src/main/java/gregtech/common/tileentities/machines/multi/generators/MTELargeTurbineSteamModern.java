...
public class MTELargeTurbineSteamModern extends MTEExtendedPowerMultiBlockBase<MTELargeTurbineSteamModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTELargeTurbineSteamModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTELargeTurbineSteamModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTELargeTurbineSteamModern.class)
                ...
                .dot(1)
                .buildAndChain(
                    onElementPass(MTELargeTurbineSteamModern::onCasingAdded, ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTELargeTurbineSteamModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTELargeTurbineSteamModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTELargeTurbineSteamModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTELargeTurbineSteamModern(this.mName);
    }
