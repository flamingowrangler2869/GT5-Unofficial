...
public class MTELargeBoilerBronzeModern extends MTEExtendedPowerMultiBlockBase<MTELargeBoilerBronzeModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTELargeBoilerBronzeModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTELargeBoilerBronzeModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTELargeBoilerBronzeModern.class)
                ...
                .dot(1)
                .buildAndChain(
                    onElementPass(MTELargeBoilerBronzeModern::onCasingAdded, ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTELargeBoilerBronzeModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTELargeBoilerBronzeModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTELargeBoilerBronzeModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTELargeBoilerBronzeModern(this.mName);
    }
