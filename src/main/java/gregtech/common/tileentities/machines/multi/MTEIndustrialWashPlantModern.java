...
public class MTEIndustrialWashPlantModern extends MTEExtendedPowerMultiBlockBase<MTEIndustrialWashPlantModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTEIndustrialWashPlantModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTEIndustrialWashPlantModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTEIndustrialWashPlantModern.class)
                ...
                .buildAndChain(
                    onElementPass(
                        MTEIndustrialWashPlantModern::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTEIndustrialWashPlantModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTEIndustrialWashPlantModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTEIndustrialWashPlantModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTEIndustrialWashPlantModern(this.mName);
    }
