...
public class MTEThermalBoilerModern extends MTEExtendedPowerMultiBlockBase<MTEThermalBoilerModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTEThermalBoilerModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTEThermalBoilerModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTEThermalBoilerModern.class)
                ...
                .dot(1)
                .buildAndChain(
                    onElementPass(MTEThermalBoilerModern::onCasingAdded, ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTEThermalBoilerModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTEThermalBoilerModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTEThermalBoilerModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTEThermalBoilerModern(this.mName);
    }
