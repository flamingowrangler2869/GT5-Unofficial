...
public class MTEIndustrialMacerationStackModern
    extends MTEExtendedPowerMultiBlockBase<MTEIndustrialMacerationStackModern> implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTEIndustrialMacerationStackModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTEIndustrialMacerationStackModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTEIndustrialMacerationStackModern.class)
                ...
                .buildAndChain(
                    onElementPass(
                        MTEIndustrialMacerationStackModern::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTEIndustrialMacerationStackModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTEIndustrialMacerationStackModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTEIndustrialMacerationStackModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTEIndustrialMacerationStackModern(this.mName);
    }
