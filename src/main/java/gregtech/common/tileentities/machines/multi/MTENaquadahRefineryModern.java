...
public class MTENaquadahRefineryModern extends MTEExtendedPowerMultiBlockBase<MTENaquadahRefineryModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTENaquadahRefineryModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTENaquadahRefineryModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTENaquadahRefineryModern.class)
                ...
                .dot(1)
                .buildAndChain(
                    onElementPass(MTENaquadahRefineryModern::onCasingAdded, ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTENaquadahRefineryModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTENaquadahRefineryModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTENaquadahRefineryModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTENaquadahRefineryModern(this.mName);
    }
