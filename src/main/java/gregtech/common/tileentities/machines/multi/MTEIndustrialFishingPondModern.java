...
public class MTEIndustrialFishingPondModern extends MTEExtendedPowerMultiBlockBase<MTEIndustrialFishingPondModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTEIndustrialFishingPondModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTEIndustrialFishingPondModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTEIndustrialFishingPondModern.class)
                ...
                .buildAndChain(
                    onElementPass(
                        MTEIndustrialFishingPondModern::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTEIndustrialFishingPondModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTEIndustrialFishingPondModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTEIndustrialFishingPondModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTEIndustrialFishingPondModern(this.mName);
    }
