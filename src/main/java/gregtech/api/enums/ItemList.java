...
public enum ItemList implements IItemContainer {
    ...
    Multi_Centrifuge,
    Multi_Electrolyzer,
    Multi_Mixing_Machine,
    Multi_Coke_Oven,
    Multi_Tree_Farm,
    Multi_Extruder,
    Multi_Arc_Furnace,
    Multi_Material_Press,
    Multi_Fishing_Port,
    Multi_Advanced_Implosion_Compressor,
    Multi_Algae_Farm,
    Multi_Pyrolyse_Oven,
    Mega_Vacuum_Freezer,
    Mega_Electric_Blast_Furnace,
    Mega_Distillation_tower,
    Drone_Centre,
    Multi_Chisel,
    Multi_Hammer,
    Multi_Packager,
