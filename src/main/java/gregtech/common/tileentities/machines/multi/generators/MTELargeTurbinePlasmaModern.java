...
public class MTELargeTurbinePlasmaModern extends MTEExtendedPowerMultiBlockBase<MTELargeTurbinePlasmaModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTELargeTurbinePlasmaModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTELargeTurbinePlasmaModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTELargeTurbinePlasmaModern.class)
                ...
                .buildAndChain(
                    onElementPass(
                        MTELargeTurbinePlasmaModern::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTELargeTurbinePlasmaModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTELargeTurbinePlasmaModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTELargeTurbinePlasmaModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTELargeTurbinePlasmaModern(this.mName);
    }
