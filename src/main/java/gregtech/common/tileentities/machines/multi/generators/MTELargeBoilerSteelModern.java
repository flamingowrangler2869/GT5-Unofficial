...
public class MTELargeBoilerSteelModern extends MTEExtendedPowerMultiBlockBase<MTELargeBoilerSteelModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTELargeBoilerSteelModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTELargeBoilerSteelModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTELargeBoilerSteelModern.class)
                ...
                .dot(1)
                .buildAndChain(
                    onElementPass(MTELargeBoilerSteelModern::onCasingAdded, ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTELargeBoilerSteelModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTELargeBoilerSteelModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTELargeBoilerSteelModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTELargeBoilerSteelModern(this.mName);
    }
