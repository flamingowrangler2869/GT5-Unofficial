...
public class MTEIndustrialArcFurnaceModern extends MTEExtendedPowerMultiBlockBase<MTEIndustrialArcFurnaceModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTEIndustrialArcFurnaceModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTEIndustrialArcFurnaceModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTEIndustrialArcFurnaceModern.class)
                ...
                .buildAndChain(
                    onElementPass(
                        MTEIndustrialArcFurnaceModern::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTEIndustrialArcFurnaceModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTEIndustrialArcFurnaceModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTEIndustrialArcFurnaceModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTEIndustrialArcFurnaceModern(this.mName);
    }
