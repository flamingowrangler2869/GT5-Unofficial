...
public class MTELargeTurbineSCSteamModern extends MTEExtendedPowerMultiBlockBase<MTELargeTurbineSCSteamModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTELargeTurbineSCSteamModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTELargeTurbineSCSteamModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTELargeTurbineSCSteamModern.class)
                ...
                .buildAndChain(
                    onElementPass(
                        MTELargeTurbineSCSteamModern::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTELargeTurbineSCSteamModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTELargeTurbineSCSteamModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTELargeTurbineSCSteamModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTELargeTurbineSCSteamModern(this.mName);
    }
