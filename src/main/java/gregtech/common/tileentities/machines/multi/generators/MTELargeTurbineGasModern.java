...
public class MTELargeTurbineGasModern extends MTEExtendedPowerMultiBlockBase<MTELargeTurbineGasModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTELargeTurbineGasModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTELargeTurbineGasModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTELargeTurbineGasModern.class)
                ...
                .dot(1)
                .buildAndChain(
                    onElementPass(MTELargeTurbineGasModern::onCasingAdded, ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTELargeTurbineGasModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTELargeTurbineGasModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTELargeTurbineGasModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTELargeTurbineGasModern(this.mName);
    }
