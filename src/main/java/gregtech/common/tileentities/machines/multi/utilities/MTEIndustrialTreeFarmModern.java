...
public class MTEIndustrialTreeFarmModern extends MTEExtendedPowerMultiBlockBase<MTEIndustrialTreeFarmModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTEIndustrialTreeFarmModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTEIndustrialTreeFarmModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTEIndustrialTreeFarmModern.class)
                ...
                .buildAndChain(
                    onElementPass(
                        MTEIndustrialTreeFarmModern::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTEIndustrialTreeFarmModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTEIndustrialTreeFarmModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTEIndustrialTreeFarmModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTEIndustrialTreeFarmModern(this.mName);
    }
