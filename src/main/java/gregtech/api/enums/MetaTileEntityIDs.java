...
public enum MetaTileEntityIDs {
    ...
    SOLAR_PANEL_UV(2740),
    MULTI_THERMAL_CENTRIFUGE(2801),
    MULTI_MACERATOR(2802),
    MULTI_WIREMILL(2803),
    MULTI_CUTTER(2804),
    MULTI_ORE_WASHER(2805),
    MULTI_SIFTER(2806),
    MULTI_CENTRIFUGE(2807),
    MULTI_ELECTROLYZER(2808),
    MULTI_MIXING_MACHINE(2809),
    MULTI_COKE_OVEN(2810),
    MULTI_TREE_FARM(2811),
    MULTI_EXTRUDER(2812),
    MULTI_ARC_FURNACE(2813),
    MULTI_MATERIAL_PRESS(2814),
    MULTI_FISHING_PORT(2815),
    MULTI_ADVANCED_IMPLOSION_COMPRESSOR(2816),
    MULTI_ALGAE_FARM(2817),
    MULTI_PYROLYSE_OVEN(2818),
    MEGA_VACUUM_FREEZER(2819),
    MEGA_ELECTRIC_BLAST_FURNACE(2820),
    MEGA_DISTILLATION_TOWER(2821),
    DRONE_CENTRE(2822),
    MULTI_CHISEL(2823),
    MULTI_HAMMER(2824),
    MULTI_PACKAGER(2825),
    MULTI_ROCK_BREAKER(2826),
    INFINITE_PUMP(2827),
    NAQUADAH_FUEL_REFINERY(2828),
    LARGE_NAQUADAH_REACTOR(2829),
