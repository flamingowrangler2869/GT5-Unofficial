...
public class MTEIndustrialImplosionCompressorModern
    extends MTEExtendedPowerMultiBlockBase<MTEIndustrialImplosionCompressorModern> implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTEIndustrialImplosionCompressorModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTEIndustrialImplosionCompressorModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTEIndustrialImplosionCompressorModern.class)
                ...
                .buildAndChain(
                    onElementPass(
                        MTEIndustrialImplosionCompressorModern::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTEIndustrialImplosionCompressorModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTEIndustrialImplosionCompressorModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTEIndustrialImplosionCompressorModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTEIndustrialImplosionCompressorModern(this.mName);
    }
