...
public class MTENaquadahGeneratorModern extends MTEExtendedPowerMultiBlockBase<MTENaquadahGeneratorModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTENaquadahGeneratorModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTENaquadahGeneratorModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTENaquadahGeneratorModern.class)
                ...
                .dot(1)
                .buildAndChain(
                    onElementPass(MTENaquadahGeneratorModern::onCasingAdded, ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTENaquadahGeneratorModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTENaquadahGeneratorModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTENaquadahGeneratorModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTENaquadahGeneratorModern(this.mName);
    }
