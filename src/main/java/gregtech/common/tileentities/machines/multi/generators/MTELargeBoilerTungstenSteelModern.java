...
public class MTELargeBoilerTungstenSteelModern extends MTEExtendedPowerMultiBlockBase<MTELargeBoilerTungstenSteelModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTELargeBoilerTungstenSteelModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTELargeBoilerTungstenSteelModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTELargeBoilerTungstenSteelModern.class)
                ...
                .buildAndChain(
                    onElementPass(
                        MTELargeBoilerTungstenSteelModern::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTELargeBoilerTungstenSteelModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTELargeBoilerTungstenSteelModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTELargeBoilerTungstenSteelModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTELargeBoilerTungstenSteelModern(this.mName);
    }
