package gregtech.common.tileentities.machines.multi.generators;
...
public class MTEUniversalChemicalFuelEngineModern
    extends MTEExtendedPowerMultiBlockBase<MTEUniversalChemicalFuelEngineModern> implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTEUniversalChemicalFuelEngineModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTEUniversalChemicalFuelEngineModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTEUniversalChemicalFuelEngineModern.class)
                ...
                .buildAndChain(
                    onElementPass(
                        MTEUniversalChemicalFuelEngineModern::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTEUniversalChemicalFuelEngineModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTEUniversalChemicalFuelEngineModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTEUniversalChemicalFuelEngineModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTEUniversalChemicalFuelEngineModern(this.mName);
    }
