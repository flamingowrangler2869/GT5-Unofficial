...
public enum MetaTileEntityIDs {
    ...
    Industrial_ThermalCentrifuge_Modern(2801),
    Industrial_MacerationStack_Modern(2802),
    Industrial_WireFactory_Modern(2803),
    Industrial_CuttingFactory_Modern(2804),
    Industrial_WashPlant_Modern(2805),
    Industrial_Sifter_Modern(2806),
    Industrial_Centrifuge_Modern(2807),
    Industrial_Electrolyzer_Modern(2808),
    Industrial_Mixer_Modern(2809),
    Industrial_CokeOven_Modern(2810),
    Industrial_TreeFarm_Modern(2811),
    Industrial_Extruder_Modern(2812),
    Industrial_Arc_Furnace_Modern(2813),
    Industrial_PlatePress_Modern(2814),
    Industrial_FishingPond_Modern(2815),
    Advanced_ImplosionCompressor_Modern(2816),
    AlgaeFarm_Modern(2817),
    Pyrolyse_Oven_Modern(2818),
    Drone_Centre_Modern(2819),
    Industrial_AutoChisel_Modern(2820),
    Industrial_ForgeHammer_Modern(2821),
    Amazon_Warehouse_Modern(2822),
    Industrial_RockBreaker_Modern(2823),
    Multiblock_Pump_Infinite_Modern(2824),
    Mega_Blast_Furnace_Modern(2825),
    Mega_Vacuum_Freezer_Modern(2826),
    Mega_Distillation_Tower_Modern(2827),
    Mega_Chemical_Reactor_Modern(2828),
    XL_Turbine_Steam_Modern(2829),
    XL_Turbine_SHSteam_Modern(2830),
    XL_Turbine_SCSteam_Modern(2831),
    XL_Turbine_Plasma_Modern(2832),
    XL_Turbine_Gas_Modern(2833),
    Large_Turbine_Steam_Modern(2834),
    Large_Turbine_SHSteam_Modern(2835),
    Large_Turbine_SCSteam_Modern(2836),
    Large_Turbine_Plasma_Modern(2837),
    Large_Turbine_Gas_Modern(2838),
    Large_Boiler_Bronze_Modern(2839),
    Large_Boiler_Steel_Modern(2840),
    Large_Boiler_Titanium_Modern(2841),
    Large_Boiler_TungstenSteel_Modern(2842),
    Extreme_combustion_Engine_Modern(2843),
    Combustion_Engine_Modern(2844),
    GT4_Thermal_Boiler_Modern(2845),
    UniversalChemicalFuelEngine_Modern(2846),
    Solid_Oxide_Fuel_Cell_MKI(2847),
    Solid_Oxide_Fuel_Cell_MKII(2848),

    Multi_Naquadah_Generator_Modern(2850),
    Multi_Naquadah_Refinery_Modern(2851),
