...
public enum MetaTileEntityIDs {
    ...
    // deprecated machinery
    Industrial_ThermalCentrifuge_Legacy(2801),
    Industrial_MacerationStack_Legacy(2802),
    Industrial_WireFactory_Legacy(2803),
    Industrial_CuttingFactoryController_Legacy(2804),
    Industrial_WashPlant_Legacy(2805),
    Industrial_Sifter_Legacy(2806),
    Industrial_Centrifuge_Legacy(2807),
    Industrial_Electrolyzer_Legacy(2808),
    Industrial_Mixer_Legacy(2809),
    Industrial_CokeOven_Legacy(2810),
    Industrial_TreeFarm_Legacy(2811),
    Industrial_Extruder_Legacy(2812),
    Industrial_Arc_Furnace_Legacy(2813),
    Industrial_PlatePress_Legacy(2814),
    Industrial_FishingPond_Legacy(2815),
    Machine_Adv_ImplosionCompressor_Legacy(2816),
    AlgaeFarm_Controller_Legacy(2817),
    PYROLYSE_OVEN_CONTROLLER_LEGACY(2818),
    Drone_Centre_Legacy(2819),
    Controller_IndustrialAutoChisel_Legacy(2820),
    Controller_IndustrialForgeHammer_Legacy(2821),
    ...
    XL_Turbine_Steam_Legacy(2828),
    XL_Turbine_SHSteam_Legacy(2829),
    XL_Turbine_SCSteam_Legacy(2830),
    XL_Turbine_Plasma_Legacy(2831),
    XL_Turbine_Gas_Legacy(2832),
    Large_Turbine_Steam_Legacy(2833),
    Large_Turbine_SHSteam_Legacy(2834),
    Large_Turbine_SCSteam_Legacy(2835),
    Large_Turbine_Plasma_Legacy(2836),
    Large_Turbine_Gas_Legacy(2837),
    Controller_Large_Boiler_Bronze_Legacy(2838),
    Controller_Large_Boiler_Steel_Legacy(2839),
    Controller_Large_Boiler_Titanium_Legacy(2840),
    Controller_Large_Boiler_TungstenSteel_Legacy(2841),
    EXTREME_COMBUSTION_ENGINE_CONTROLLER_LEGACY(2842),
    COMBUSTION_ENGINE_CONTROLLER_LEGACY(2843),
    GT4_Thermal_Boiler_Legacy(2844),
