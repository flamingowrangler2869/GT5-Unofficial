...
public class MTEOilDrillInfiniteModern extends MTEExtendedPowerMultiBlockBase<MTEOilDrillInfiniteModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTEOilDrillInfiniteModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTEOilDrillInfiniteModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTEOilDrillInfiniteModern.class)
                ...
                .dot(1)
                .buildAndChain(
                    onElementPass(MTEOilDrillInfiniteModern::onCasingAdded, ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTEOilDrillInfiniteModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTEOilDrillInfiniteModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTEOilDrillInfiniteModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTEOilDrillInfiniteModern(this.mName);
    }
