...
public class MTEMegaDistillationTowerModern extends MTEExtendedPowerMultiBlockBase<MTEMegaDistillationTowerModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTEMegaDistillationTowerModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTEMegaDistillationTowerModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTEMegaDistillationTowerModern.class)
                ...
                .buildAndChain(
                    onElementPass(
                        MTEMegaDistillationTowerModern::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTEMegaDistillationTowerModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTEMegaDistillationTowerModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTEMegaDistillationTowerModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTEMegaDistillationTowerModern(this.mName);
    }
