...
public class MTEDieselEngineExtremeModern extends MTEExtendedPowerMultiBlockBase<MTEDieselEngineExtremeModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTEDieselEngineExtremeModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTEDieselEngineExtremeModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTEDieselEngineExtremeModern.class)
                ...
                .buildAndChain(
                    onElementPass(
                        MTEDieselEngineExtremeModern::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTEDieselEngineExtremeModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTEDieselEngineExtremeModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTEDieselEngineExtremeModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTEDieselEngineExtremeModern(this.mName);
    }
