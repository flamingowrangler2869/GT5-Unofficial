...
public class MTESOFuelCellMK2Modern extends MTEExtendedPowerMultiBlockBase<MTESOFuelCellMK2Modern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTESOFuelCellMK2Modern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTESOFuelCellMK2Modern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTESOFuelCellMK2Modern.class)
                ...
                .dot(1)
                .buildAndChain(
                    onElementPass(MTESOFuelCellMK2Modern::onCasingAdded, ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTESOFuelCellMK2Modern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTESOFuelCellMK2Modern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTESOFuelCellMK2Modern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTESOFuelCellMK2Modern(this.mName);
    }
