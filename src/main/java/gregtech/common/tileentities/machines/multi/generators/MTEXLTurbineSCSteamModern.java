...
public class MTEXLTurbineSCSteamModern extends MTEExtendedPowerMultiBlockBase<MTEXLTurbineSCSteamModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTEXLTurbineSCSteamModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTEXLTurbineSCSteamModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTEXLTurbineSCSteamModern.class)
                ...
                .dot(1)
                .buildAndChain(
                    onElementPass(MTEXLTurbineSCSteamModern::onCasingAdded, ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTEXLTurbineSCSteamModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTEXLTurbineSCSteamModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTEXLTurbineSCSteamModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTEXLTurbineSCSteamModern(this.mName);
    }
