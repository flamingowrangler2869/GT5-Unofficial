...
public class MTELargeBoilerTitaniumModern extends MTEExtendedPowerMultiBlockBase<MTELargeBoilerTitaniumModern>
    implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<MTELargeBoilerTitaniumModern> STRUCTURE_DEFINITION = StructureDefinition
        .<MTELargeBoilerTitaniumModern>builder()
        .addShape(
        ...
        .addElement(
            'B',
            buildHatchAdder(MTELargeBoilerTitaniumModern.class)
                ...
                .buildAndChain(
                    onElementPass(
                        MTELargeBoilerTitaniumModern::onCasingAdded,
                        ofBlock(GregTechAPI.sBlockCasings10, 15))))
        .addElement('A', chainAllGlasses())
        .addElement('C', ofFrame(Materials.Steel))
        .build();

    public MTELargeBoilerTitaniumModern(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTELargeBoilerTitaniumModern(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<MTELargeBoilerTitaniumModern> getStructureDefinition() {
        return STRUCTURE_DEFINITION;
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTELargeBoilerTitaniumModern(this.mName);
    }
